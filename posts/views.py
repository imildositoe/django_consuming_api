from posts.forms import Login, User
...
def get_user(request):
    ...
    if form.is_valid():
        ...
        r = requests.get('http://localhost:8080/dawapi/usuario/' + id_user, headers=header1)
        data = r.json()
        return render(request, 'posts/index.html', {'data': data})
    return render(request, 'posts/index.html')
